            ...
            if result is not None:
                ...
                if hasattr(engine, 'frame_count') and engine.frame_count % 100 == 0:
                    socketio.emit('engine_status', {
                        ...
                        'frame_count': _safe_int(engine.frame_count),
                        'device_info': {
...
def start_engine():
    ...
    try:
        ...
        device_config = DeviceConfig(
            ...
            stream_channels=(request.json.get('stream_channels') if request.is_json else None),
            channel_map=(request.json.get('channel_map') if request.is_json else None)
        )
